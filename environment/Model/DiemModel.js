...
async function Create(Data) {
    ...
    let sqsDiemData = {
        ...
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/428111406492/InsertDiem'
    };
...
async function Update(ID, ID1, Data) {
    ...
    let sqsDiemData = {
        ...
        MessageBody: JSON.stringify(DiemData),
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/428111406492/UpdateDiem'
    };
    let sendSqsMessage = sqs.sendMessage(sqsDiemData).promise();
    sendSqsMessage.then((data) => {
        console.log(`OrdersSvc | SUCCESS: ${data.MessageId}`);
...
async function Delete(ID, ID1) {
    ...
    let sqsDiemData = {
        ...
        MessageBody: JSON.stringify(DiemData),
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/428111406492/DeleteDiem'
    };
    let sendSqsMessage = sqs.sendMessage(sqsDiemData).promise();
    sendSqsMessage.then((data) => {
        console.log(`OrdersSvc | SUCCESS: ${data.MessageId}`);
