...
const queueUrl = "https://sqs.us-east-1.amazonaws.com/428111406492/test";
...
async function Update(ID, Khoa) {
    ...
    let sqsKhoaData = {
        ...
        MessageBody: JSON.stringify(KhoaData),
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/428111406492/UpdateKhoa'
    };
    let sendSqsMessage = sqs.sendMessage(sqsKhoaData).promise();
    sendSqsMessage.then((data) => {
        console.log(`OrdersSvc | SUCCESS: ${data.MessageId}`);
...
async function Delete(ID) {
    ...
    let sqsKhoaData = {
        ...
        MessageBody: JSON.stringify(KhoaData),
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/428111406492/DeleteKhoa'
    };
    let sendSqsMessage = sqs.sendMessage(sqsKhoaData).promise();
    sendSqsMessage.then((data) => {
        console.log(`OrdersSvc | SUCCESS: ${data.MessageId}`);
