...
async function Create(Data) {
    ...
    let sqsDiemData = {
        ...
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/428111406492/InsertPhanCong'
    };
...
async function Delete(MaGV, MaMon, MaLop) {
    ...
    let sqsDiemData = {
        ...
        MessageBody: JSON.stringify(DiemData),
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/428111406492/DeletePhanCong'
    };
    let sendSqsMessage = sqs.sendMessage(sqsDiemData).promise();
    sendSqsMessage.then((data) => {
        console.log(`OrdersSvc | SUCCESS: ${data.MessageId}`);
...
async function Update(MaGV, MaMon, MaLop) {
    ...
    let sqsDiemData = {
        ...
        MessageBody: JSON.stringify(DiemData),
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/428111406492/UpdatePhanCong'
    };
    let sendSqsMessage = sqs.sendMessage(sqsDiemData).promise();
    sendSqsMessage.then((data) => {
        console.log(`OrdersSvc | SUCCESS: ${data.MessageId}`);
