...
async function Create(Data) {
    ...
    let sqsMonHocData = {
        ...
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/428111406492/InsertMonHoc'
    };
...
async function Update(ID, Data) {
    ...
    let sqsMonHocData = {
        ...
        MessageBody: JSON.stringify(MonHocData),
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/428111406492/UpdateMonHoc'
    };
    let sendSqsMessage = sqs.sendMessage(sqsMonHocData).promise();
    sendSqsMessage.then((data) => {
        console.log(`OrdersSvc | SUCCESS: ${data.MessageId}`);
...
async function Delete(ID) {
    ...
    let sqsMonHocData = {
        ...
        MessageBody: JSON.stringify(MonHocData),
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/428111406492/DeleteMonHoc'
    };
    let sendSqsMessage = sqs.sendMessage(sqsMonHocData).promise();
    sendSqsMessage.then((data) => {
        console.log(`OrdersSvc | SUCCESS: ${data.MessageId}`);
