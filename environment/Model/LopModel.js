...
async function Create(Data) {
    ...
    let sqsLopData = {
        ...
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/428111406492/InsertLop'
    };
...
async function Update(ID, TenLop, MaKhoa) {
    ...
    let sqsLopData = {
        ...
        MessageBody: JSON.stringify(LopData),
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/428111406492/UpdateLop'
    };
    let sendSqsMessage = sqs.sendMessage(sqsLopData).promise();
    sendSqsMessage.then((data) => {
        console.log(`OrdersSvc | SUCCESS: ${data.MessageId}`);
...
async function Delete(ID) {
    ...
    let sqsLopData = {
        ...
        MessageBody: JSON.stringify(LopData),
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/428111406492/DeleteLop'
    };
    let sendSqsMessage = sqs.sendMessage(sqsLopData).promise();
    sendSqsMessage.then((data) => {
        console.log(`OrdersSvc | SUCCESS: ${data.MessageId}`);
